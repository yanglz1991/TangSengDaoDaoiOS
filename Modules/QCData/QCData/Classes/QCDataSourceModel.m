...
+(QCModel*) fromMap:(NSDictionary*)dictory type:(ModelMapType)type {
    QCGroupModel *groupModel = [QCGroupModel new];
...
@implementation QCGroupMemberModel

+ (QCModel *)fromMap:(NSDictionary *)dictory type:(ModelMapType)type {
    QCGroupMemberModel *model = [QCGroupMemberModel new];
...
-(QCChannelMember*) toChannelMember{
    QCChannelMember *channelMember = [QCChannelMember new];
