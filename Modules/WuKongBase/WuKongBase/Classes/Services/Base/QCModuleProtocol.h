...
typedef enum : NSUInteger {
    QCModuleTypeDefault,
    QCModuleTypeResource
} QCModuleType;


NS_ASSUME_NONNULL_BEGIN
@protocol QCModuleProtocol <NSObject>
/**
 module id 全局唯一
 ...
 */
- (void)moduleInit:(QCModuleContext*_Nonnull)context;
...
/**
 ...
 @param context <#context description#>
 */
-(BOOL) moduleDidFinishLaunching:(QCModuleContext*_Nonnull) context;
