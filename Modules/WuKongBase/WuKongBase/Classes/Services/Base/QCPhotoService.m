...
@interface QCPhotoService ()<UIImagePickerControllerDelegate,UINavigationControllerDelegate>
...
@implementation QCPhotoService
static QCPhotoService *_instance;
+ (QCPhotoService *)shared {
    if (_instance == nil) {
