...
@implementation QCMeItemModel

-(Class) cell {
    return QCMeItemCell.class;
}
@end

@interface QCMeItemCell ()
...
@implementation QCMeItemCell

+(CGSize) sizeForModel:(QCMeItemModel*)model{
...
- (void)refresh:(QCMeItemModel*)cellModel {
