...
/// Project version number for QCCollectionViewGridLayout.
FOUNDATION_EXPORT double QCCollectionViewGridLayoutVersionNumber;

/// Project version string for QCCollectionViewGridLayout.
FOUNDATION_EXPORT const unsigned char QCCollectionViewGridLayoutVersionString[];

@interface QCCollectionViewGridLayout : UICollectionViewLayout
...
@interface QCCollectionViewGridLayout (QCCollectionViewGridLayout_Deprecated)
