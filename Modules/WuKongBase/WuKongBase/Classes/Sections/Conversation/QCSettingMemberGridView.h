...
@class QCSettingMemberGridView;
@protocol QCSettingMemberGridViewDelegate <NSObject>
...
@interface QCSettingMemberGridView : UIView
...
@property(nonatomic,weak) id<QCSettingMemberGridViewDelegate> delegate;
