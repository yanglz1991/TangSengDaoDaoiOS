...
@interface QCConversationWrapModel : NSObject
...
@property(nonatomic,strong,readonly) QCChannel *parentChannel;
...
-(void) setChannelInfo:(QCChannelInfo * _Nullable)channelInfo;
...
@property(nonatomic,strong) NSArray<QCReminder*> *simpleReminders;
