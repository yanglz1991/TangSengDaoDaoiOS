...
#import "QCCommon.h"
#import "QCTextView.h"
@interface QCGrowingTextView()<UITextViewDelegate>{
...
@implementation QCGrowingTextView
...
-(UITextView*)internalTextView {
    if(!_internalTextView) {
        _internalTextView = [[QCTextView alloc] init];
...
- (void)refreshHeight:(bool)textChanged{
    ...
    id<QCGrowingTextViewDelegate> delegate = _delegate;
