...
#import "WuKongBase.h"
@interface QCOneSideShadowView ()



@end

@implementation QCOneSideShadowView
...
-(void) prepare {
    ...
    self.shadowProviderLayer.backgroundColor = [QCApp shared].config.themeColor.CGColor;
