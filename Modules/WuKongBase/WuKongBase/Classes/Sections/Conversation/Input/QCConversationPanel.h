...
#define QCPanelDefaultHeight 302.0f // 面板默认高度

@interface QCConversationPanel : UIView

/**
 输入框委托事件
 */
//@property(nonatomic,weak) id<QCInputProto> inputDelegate;
// 会话委托
