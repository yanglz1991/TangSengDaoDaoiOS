...
@interface QCScanBottom ()

@property(nonatomic,strong) QCIconButton *albumBtn; // 相册
@property(nonatomic,strong) QCIconSwitchButton *openLightBtn; // 开灯
@property(nonatomic,strong) QCIconButton *myQRCodeBtn; // 我的二维码
@end

@implementation QCScanBottom
...
- (QCIconButton *)albumBtn {
    if(!_albumBtn) {
        _albumBtn = [[QCIconButton alloc] init];
        ...
        _albumBtn.titleLbl.font = [QCApp.shared.config appFontOfSize:12.0f];
...
- (QCIconSwitchButton *)openLightBtn {
    if(!_openLightBtn) {
        _openLightBtn = [[QCIconSwitchButton alloc] initWithIconSize:CGSizeMake(20.0f, 20.0f)];
        ...
        _openLightBtn.onTitleLbl.font = [QCApp.shared.config appFontOfSize:12.0f];
        ...
        _openLightBtn.offTitleLbl.font = [QCApp.shared.config appFontOfSize:12.0f];
...
- (QCIconButton *)myQRCodeBtn {
    if(!_myQRCodeBtn) {
        _myQRCodeBtn = [[QCIconButton alloc] init];
        ...
        _myQRCodeBtn.titleLbl.font = [QCApp.shared.config appFontOfSize:12.0f];
