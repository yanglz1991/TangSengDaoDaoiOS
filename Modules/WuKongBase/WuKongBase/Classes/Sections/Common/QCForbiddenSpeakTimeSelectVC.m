//
//  QCForbiddenSpeakTimeSelectVC.m
//  WuKongBase
//
...
@interface QCForbiddenSpeakTimeSelectVC ()<QCForbiddenSpeakTimeSelectVMDelegate,ActionSheetCustomPickerDelegate>
...
@implementation QCForbiddenSpeakTimeSelectVC

- (instancetype)init
{
    self = [super init];
    if (self) {
        self.viewModel = [[QCForbiddenSpeakTimeSelectVM alloc] init];
