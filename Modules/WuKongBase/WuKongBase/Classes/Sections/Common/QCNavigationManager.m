...
@interface QCNavigationManager ()

@property(nonatomic,strong) Class rootNavigationControllerClass;

@end

@implementation QCNavigationManager


static QCNavigationManager *_instance = nil;
...
-(void) resetRootViewController:(UIViewController*)viewController{
    if(self.rootNavigationControllerClass) {
        ...
        _rootNavigationController = [[QCRootNavigationController alloc] initWithRootViewController:viewController];
    }
