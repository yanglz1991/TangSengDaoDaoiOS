...
#import "WuKongBase.h"
@interface QCStickerImageViewInner : SDAnimatedImageView
...
@interface QCStickerImageView ()

@property(nonatomic,strong) QCStickerImageViewInner *stickerImgView;
...
@implementation QCStickerImageView
...
-(void) setupUI {
    self.stickerImgView = [[QCStickerImageViewInner alloc] initWithFrame:CGRectMake(0.0f, 0.0f, self.size.width, self.size.height)];
...
//    }
    ...
    if(!self.placeholder.view.superview) {
        placeholderImg = [QCApp shared].config.defaultStickerPlaceholder;
    }
...
@implementation QCStickerImageViewInner
