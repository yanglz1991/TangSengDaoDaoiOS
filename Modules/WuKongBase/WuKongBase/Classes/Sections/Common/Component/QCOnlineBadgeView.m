...
@implementation QCOnlineBadgeView

+(instancetype) initWithTip:(NSString*)tip {
    QCOnlineBadgeView *v = [[QCOnlineBadgeView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 15.0f, 15.0f)];
    v.tip = tip;
    return v;
}
...
#define tipFont  [[QCApp shared].config appFontOfSizeMedium:10.0f]
- (UIView *)circleLbl {
    if(!_circleLbl) {
