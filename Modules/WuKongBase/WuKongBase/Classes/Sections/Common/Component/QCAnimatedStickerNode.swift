...
@objc public class QCAnimatedStickerNode:NSObject {
    ...
    @objc public func setup(url:String,size:CGSize) {
        animatedStickerNode.setup(source: QCAnimatedStickerResourceSource(downloadURL: url), width: Int(size.width), height: Int(size.height),playbackMode: .loop, mode: .direct(cachePathPrefix: "sticker_"))
    }
