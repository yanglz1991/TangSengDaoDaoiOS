...
#import "QCApp.h"
#import "WuKongBase.h"
@interface QCTabPageView ()<UIScrollViewDelegate,QCPageViewDelegate,QCPageViewDataSource>


@property(nonatomic,strong) UIView *maskView; // 遮挡层

@property(nonatomic,strong) QCPageView *pageView;
...
-(QCPageView*) pageView {
    if(!_pageView) {
        _pageView = [[QCPageView alloc] init];
...
#pragma mark - QCPageViewDelegate
