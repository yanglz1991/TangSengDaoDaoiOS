...
/** Animation object used by QCCheckBox to generate animations.
 */
@interface QCAnimationManager : NSObject

/** The duration of the animation created by the QCAnimationManager object.
 */
@property (nonatomic) CGFloat animationDuration;

/** Designated initializer.
 * @param animationDuration The duration of the animations created with the QCAnimationManager object.
 * @return Returns the a fully initialized QCAnimationManager object.
 */
