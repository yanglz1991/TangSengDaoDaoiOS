...
/** The QCAnimationManager object used to generate animations.
 */
@property (strong, nonatomic) QCAnimationManager *animationManager;

/** The QCPathManager object used to generate paths.
 */
@property (strong, nonatomic) QCPathManager *pathManager;
...
- (void)initPathManager {
    _pathManager = [QCPathManager new];
...
- (void)initAnimationManager {
    _animationManager = [[QCAnimationManager alloc] initWithAnimationDuration:_animationDuration];
}
