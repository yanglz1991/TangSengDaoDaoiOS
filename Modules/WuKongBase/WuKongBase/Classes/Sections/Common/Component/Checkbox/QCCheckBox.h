...
IB_DESIGNABLE @interface QCCheckBox : UIControl <CAAnimationDelegate>
#else
IB_DESIGNABLE @interface QCCheckBox : UIControl
#endif
...
* @discussion The delegate must adopt the \p QCCheckBoxDelegate protocol. The delegate is not retained.
 */
@property (nonatomic, weak) IBOutlet id <QCCheckBoxDelegate> delegate;

/** This property allows you to retrieve and set (without animation) a value determining whether the QCCheckBox object is On or Off.
  * Default to NO.
 */
 ...
 */
@property (strong, nonatomic, nullable, readonly) QCCheckBoxGroup *group;
...
/** The QCCheckBoxDelegate protocol. Used to receive life cycle events.
 */
@protocol QCCheckBoxDelegate <NSObject>
 ...
 * @param checkBox The QCCheckBox instance that has been tapped.
 */
 ...
 * @param checkBox The QCCheckBox instance that was animated.
 */
- (void)animationDidStopForCheckBox:(QCCheckBox *)checkBox;
