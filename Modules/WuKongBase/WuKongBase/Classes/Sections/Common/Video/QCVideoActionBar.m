...
@interface QCVideoBrowseActionSlider : UISlider
@end
@implementation QCVideoBrowseActionSlider
...
@interface QCVideoActionBar ()
@property (nonatomic, strong) UIButton *playButton;
@property (nonatomic, strong) UILabel *preTimeLabel;
@property (nonatomic, strong) UILabel *sufTimeLabel;
@property (nonatomic, strong) QCVideoBrowseActionSlider *slider;
@end

@implementation QCVideoActionBar {
    BOOL _dragging;
}
...
- (QCVideoBrowseActionSlider *)slider {
    if (!_slider) {
        _slider = [QCVideoBrowseActionSlider new];
