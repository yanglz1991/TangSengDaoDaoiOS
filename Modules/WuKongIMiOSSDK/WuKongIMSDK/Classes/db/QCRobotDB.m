...
@implementation QCRobotDB

static QCRobotDB *_instance;
...
-(QCRobot*) toRobot:(FMResultSet*)result {
    ...
    if(menusJSON && ![menusJSON isEqualToString:@""]) {
        ...
        if(!err) {
            ...
            for (NSDictionary *menusDict in menusDicts) {
                QCRobotMenus *m = [self toRobotMenus:menusDict];
...
-(QCRobotMenus*) toRobotMenus:(NSDictionary*)dict {
