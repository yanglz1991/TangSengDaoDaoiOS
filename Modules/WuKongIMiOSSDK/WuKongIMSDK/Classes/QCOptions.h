...
typedef QCConnectInfo*_Nonnull(^QCConnectInfoCallback)(void);


@interface QCOptions : NSObject
...
/**
 连接信息回调
 */
@property(nonatomic,copy) QCConnectInfoCallback connectInfoCallback;


/**
连接信息
 */
@property(nullable,nonatomic,strong) QCConnectInfo *connectInfo;
/**
 是否是debug模式
 */
...
/// 协议类型
@property(nonatomic,assign) QCProto proto;
