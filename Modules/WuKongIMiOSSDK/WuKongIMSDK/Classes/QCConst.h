...
typedef enum : NSInteger {
    QCDeviceFlagEnumUnknown = -1, // 未知
    QCDeviceFlagEnumAPP = 0, // APP
    QCDeviceFlagEnumWeb = 1, // Web
    QCDeviceFlagEnumPC = 2 // PC
} QCDeviceFlagEnum;
...
// cmd sign签名错误
#define QCCMDSignError @"cmdSignError"

// 排序序号因子
#define QCOrderSeqFactor 1000

// 默认协议版本
#define QCDefaultProtoVersion 0x4;
