...
@implementation QCBackoff

+ (instancetype)createWithBuilder:(QCBackoffBuilderBlock)block; {
    return [[self alloc] initWithBuilder:[QCBackoffBuilder builderWithBlock:block]];
}

+ (instancetype)create; {
    return [[self alloc] initWithBuilder:[QCBackoffBuilder builderWithBlock:^(QCBackoffBuilder *configuration) {
    }]];
}

- (id)initWithBuilder:(QCBackoffBuilder *)builder; {
    self = [super init];
