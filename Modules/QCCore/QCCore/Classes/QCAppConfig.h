...
@class QCAppModuleResp;

@class QCThemeContextMenu;
typedef enum : NSUInteger {
    QCSystemStyleUnknown, // 未知样式
    QCSystemStyleLight, // 亮色模式
    QCSystemStyleDark, // 深色模式
} QCSystemStyle; // 系统样式


NS_ASSUME_NONNULL_BEGIN

@interface QCAppConfig : NSObject
...
@property(nonatomic,assign) QCSystemStyle style;
...
@property(nonatomic,strong) QCThemeContextMenu *contextMenu; // 上下文菜单主体
...
@property(nonatomic,strong) NSArray<QCRTCIceServer*> *rtcIces; // rtc的ice配置

@end

@interface QCAppRemoteConfig : NSObject
...
@property(nonatomic,strong) NSArray<QCAppModuleResp*> *modules;
...
@interface QCThemeContextMenu : NSObject
...
typedef enum : NSInteger {
    QCAppModuleStatusDisable, // 不选中不可用
    QCAppModuleStatusEdit, // 选中可编辑
    QCAppModuleStatusNoEdit, // 选中 不可编辑
} QCAppModuleStatus;

@interface QCAppModuleResp : QCModel
