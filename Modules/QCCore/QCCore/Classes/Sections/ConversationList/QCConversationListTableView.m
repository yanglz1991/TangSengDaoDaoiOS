...
#import "QCCore.h"
@interface QCConversationListTableView ()

@property (nonatomic) BOOL needsReloadWhenPutOnScreen;

@end

@implementation QCConversationListTableView
...
-(void)didMoveToWindow
{
    ...
    if (self.window != nil)
    {
        ...
        {
            QCLogDebug(@"Got dirtied while offscreen. reload.");
