...
typedef enum : NSUInteger {
    QCVoicePlayStatusUnknown,
    QCVoicePlayStatusNoPlay, // 没有播放
    QCVoicePlayStatusPlaying, // 播放中
    QCVoicePlayStatusPause, // 暂停
} QCVoicePlayStatus;
...
// 上一条消息
@property(nonatomic,weak) QCMessageModel *preMessageModel;
// 下一条消息
@property(nonatomic,weak) QCMessageModel *nextMessageModel;

@property(nonatomic,strong) QCMessage *message;

@property(nonatomic,strong) QCSetting *setting;
...
// 发送者在频道的成员信息
@property(nonatomic,strong,readonly) QCChannelMember *memberOfFrom;
// 发送者数据
@property(nonatomic,strong,nullable) QCChannelInfo *from;
// 接收者uid
@property(nonatomic,copy,readonly) NSString *toUid;
// 频道
@property(nonatomic,strong,readonly) QCChannel *channel;
@property(nullable,nonatomic,strong,readonly) QCChannelInfo *channelInfo;
// 正文类型
@property(nonatomic,assign,readonly) NSInteger contentType;
// 消息正文
@property(nonatomic,strong,readonly) QCMessageContent *content;
// 是否是发送消息
...
@property(nonatomic,strong,readonly) QCMessageExtra *remoteExtra;
...
// 消息状态
@property(nonatomic,assign) QCMessageStatus status;
@property(nonatomic,assign,readonly) QCReason reasonCode;
@property(nonatomic,strong) NSMutableAttributedString *reason; // 原因内容

@property(nonatomic,weak,readonly) id<QCTaskProto> task;
// 本地扩展数据
...
// ---------- 音频消息相关 ----------
// 播放状态
@property(nonatomic,assign) QCVoicePlayStatus voicePlayStatus;
// 语音播放进度 0-1.0之间
...
// 所有回应
@property(nonatomic,strong,readonly) NSArray<QCReaction*> *reactions;

// 回应最多的三个emoji
@property(nonatomic,strong,readonly) NSArray<QCReaction*> *reactionTop3;
...
@property(nonatomic,assign) QCStreamFlag streamFlag;

@property(nonatomic,strong,readonly) NSMutableArray<QCStream*> *streams;
