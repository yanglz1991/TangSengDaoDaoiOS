...
@implementation QCIconSwitchButton
...
- (UILabel *)onTitleLbl {
    if(!_onTitleLbl) {
        ...
        _onTitleLbl.font = [QCApp.shared.config appFontOfSize:15.0f];
...
- (UILabel *)offTitleLbl {
    if(!_offTitleLbl) {
        ...
        _offTitleLbl.font = [QCApp.shared.config appFontOfSize:15.0f];
...
- (UIFont *)titleFont {
    if(!_titleFontInner) {
        _titleFontInner =  [QCApp.shared.config appFontOfSize:15.0f];
    }
