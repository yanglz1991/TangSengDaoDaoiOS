...
@implementation QCMessageReactionModel
...
@implementation QCContextMenusVC
...
- (UIVisualEffectView *)effectView {
    if(!_effectView) {
        _effectView = [[UIVisualEffectView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, QCScreenWidth, QCScreenHeight)];
...
- (UIScrollView *)scrollView {
    if(!_scrollView) {
        _scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, QCScreenWidth, QCScreenHeight)];
