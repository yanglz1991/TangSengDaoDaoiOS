...
@objc public class QCReactionContextItem:NSObject {
    ...
    @objc public let appearAnimation: QCReactionFile
    @objc public let stillAnimation: QCReactionFile
    @objc public let listAnimation: QCReactionFile
    @objc public let largeListAnimation: QCReactionFile
    @objc public let applicationAnimation: QCReactionFile
    @objc public let largeApplicationAnimation: QCReactionFile
    @objc public init(
        reaction: String,
        appearAnimation: QCReactionFile,
        stillAnimation: QCReactionFile,
        listAnimation: QCReactionFile,
        largeListAnimation: QCReactionFile,
        applicationAnimation: QCReactionFile,
        largeApplicationAnimation: QCReactionFile
    ) {
...
@objc public class QCReactionFile:NSObject {
