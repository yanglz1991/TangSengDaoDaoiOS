...
@implementation QCTextFieldItemModel
...
- (Class)cell {
    return QCTextFieldItemCell.class;
}
...
@interface QCTextFieldItemCell ()<UITextFieldDelegate>

@property(nonatomic,strong) UILabel *label;
@property(nonatomic,strong) UITextField *inputTextFd;
@property(nonatomic,strong) QCTextFieldItemModel *model;
@end

@implementation QCTextFieldItemCell
...
- (void)refresh:(QCTextFieldItemModel *)model {
    [super refresh:model];
    self.model = model;
