...
@implementation QCAvatarTitleModel

- (Class)cell {
    return QCAvatarTitleCell.class;
}
...
@implementation QCAvatarTitleCell
...
- (void)refresh:(QCAvatarTitleModel *)model {
    [super refresh:model];
