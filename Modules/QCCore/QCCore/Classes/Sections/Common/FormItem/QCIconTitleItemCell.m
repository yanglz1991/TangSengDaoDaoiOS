...
@implementation QCIconTitleItemModel
...
-(Class) cell {
    return QCIconTitleItemCell.class;
}

@end

@interface QCIconTitleItemCell ()

@end

@implementation QCIconTitleItemCell

+(CGSize) sizeForModel:(QCIconTitleItemModel*)model{
...
- (void)refresh:(QCIconTitleItemModel*)cellModel {
