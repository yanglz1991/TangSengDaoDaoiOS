...
//        UIImage *unEditImage = [[QCResource shared] resourceForImage:@"sticker_UnEdit" podName:@"QCCore_images"];
//        UIImage *editImage = [[QCResource shared] resourceForImage:@"sticker_edit" podName:@"QCCore_images"];
