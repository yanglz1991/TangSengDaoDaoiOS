...
@interface QCCollectionViewGridLayout ()
...
@implementation QCCollectionViewGridLayout
...
@interface QCCollectionViewGridLayout (InspectableScrolling)

@property (nonatomic, assign) IBInspectable BOOL verticalScrolling;

@end

@implementation QCCollectionViewGridLayout (InspectableScrolling)
...
@implementation QCCollectionViewGridLayout (QCCollectionViewGridLayout_Deprecated)
