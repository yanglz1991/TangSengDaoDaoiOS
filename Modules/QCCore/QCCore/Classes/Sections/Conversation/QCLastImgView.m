...
-(void) containerViewClick {
    if(self.onClick) {
        ...
        [[PHImageManager defaultManager] requestImageForAsset:self.lastAsset targetSize:CGSizeMake(QCScreenWidth*3, QCScreenHeight*3) contentMode:PHImageContentModeDefault options:options resultHandler:^(UIImage * _Nullable result, NSDictionary * _Nullable info) {
...
- (UILabel *)tipLbl {
    if(!_tipLbl) {
        ...
        [_tipLbl setFont:[[QCApp shared].config appFontOfSize:12.0f]];
