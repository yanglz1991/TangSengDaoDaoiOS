...
@protocol QCConversationInputPanelDelegate <NSObject>
...
-(void) switchPanel:(QCConversationInputPanel *)inputPanel pointID:(NSString*)pointID;
...
/**
 ...
 @param seconds 录音秒数
 */
- (void)inputPanelSend:(QCConversationInputPanel *)inputPanel voiceData:(NSData*)voiceData seconds: (double)seconds;

// 触发@功能开始
-(void) inputPanelMentionStart:(QCConversationInputPanel *)inputPanel;

// 触发@功能结束
-(void) inputPanelMentionEnd:(QCConversationInputPanel *)inputPanel;

// 删除提及
-(void) inputPanel:(QCConversationInputPanel *)inputPanel delMention:(NSRange)range;
...
// 输入框委托
@property(nonatomic,weak) id<QCConversationInputPanelDelegate> delegate;
// 会话委托
...
@property(nonatomic,strong) QCConversationPanel *conversationPanel; // 面板对象
