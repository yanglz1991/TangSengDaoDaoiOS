...
@interface QCConversationTableView ()

@property(nonatomic,strong) UIEvent *beganEvent;

@end

@implementation QCConversationTableView
...
-(void) didTap:(UITapGestureRecognizer*)gesture {
    if ([_conversationTableDelegate conformsToProtocol:@protocol(QCConversationTableViewDelegate)] &&
