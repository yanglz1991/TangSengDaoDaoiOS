...
@interface QCConversation : NSObject<NSCopying>

@property(nonatomic,strong) QCChannel *channel; // 频道

@property(nonatomic,strong,nullable) QCChannel *parentChannel; // 父类频道
/**
 ...
 */
@property(nonatomic,strong) QCMessage *lastMessage;

/**
 最后一条消息（如果没有不进行数据库加载）
 */
@property(nonatomic,strong) QCMessage *lastMessageInner;
...
@property(nonatomic,strong,readonly) NSArray<QCReminder*> *simpleReminders; // 除去重复的type了的reminder
