...
@implementation QCImageContent

+ (instancetype)initWithImage:(UIImage *)image {
    QCImageContent *content = [QCImageContent new];
...
- (void) writeDataToLocalPath {
   ...
   if(self.orgImage) {
       ...
       self.height = self.orgImage.size.height;
        ...
        NSData *thumdData = [self compressImageSize:self.orgImage toByte:[QCSDK shared].options.imageMaxBytes];
    ...
    if(self.data) {
        if(self.thumbData) {
            ...
            NSData *thumbData = [self compressImageSize:[UIImage imageWithData:self.data] toByte:[QCSDK shared].options.imageMaxBytes];
