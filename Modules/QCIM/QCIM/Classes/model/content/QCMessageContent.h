...
extern NSString *  _Nonnull const QCEntityTypeRobotCommand; // robot命令

#import <Foundation/Foundation.h>
#import "QCUserInfo.h"
#import <fmdb/FMDB.h>
@class QCMessageContent;
...
/*!
 @提醒的类型
 */
typedef NS_ENUM(NSUInteger, QCMentionedType) {
    /*!
     @所有人
     */
    WK_Mentioned_All = 1,
...
@interface QCMessageEntity : NSObject
@property(nonatomic,copy) NSString *type;
@property(nonatomic,assign) NSRange range;
@property(nonatomic,strong) id value;

+(QCMessageEntity*) type:(NSString*)type range:(NSRange)range;
+(QCMessageEntity*) type:(NSString*)type range:(NSRange)range value:(id _Nullable)value;
@end

/**
  消息中的@提醒信息
 */
@interface QCMentionedInfo : NSObject
...
/*!
 @提醒的类型
 */
@property (nonatomic, assign) QCMentionedType type;
...
@property(nonatomic,strong) QCMessageContent *content; // 被回复的消息正文

@end

@class QCMessage;
@interface QCMessageContent : NSObject<NSCopying>

//TODO: 这里要注意不能声明为strong 如果声明为strong message和media互相引用 就释放不掉了导致内存爆炸。
@property(nonatomic,weak) QCMessage *message;

/**
  消息内容中携带的发送者的用户信息
 */
@property (nonatomic, strong) QCUserInfo *senderUserInfo;

/*!
 消息中的@提醒信息
 */
@property (nonatomic, strong) QCMentionedInfo *mentionedInfo;


/// 回复内容
@property(nonatomic,strong) QCReply *reply;
...
/// 消息entitiy项
@property(nonatomic,strong) NSArray<QCMessageEntity*> *entities;
