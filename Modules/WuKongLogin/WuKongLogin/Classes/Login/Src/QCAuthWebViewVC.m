...
#import "QCLoginVM.h"
@interface QCAuthWebViewVC ()

@property(nonatomic,strong) NSTimer *timer;

@end

@implementation QCAuthWebViewVC
...
-(void) startCheckAuthStatus:(NSString*)authcode {
    ...
    [QCAPIClient.sharedClient GET:@"user/thirdlogin/authstatus" parameters:@{
        @"authcode": authcode,
...
-(void) login:(NSDictionary*)dataDict {
    QCLoginResp *resp = (QCLoginResp*)[QCLoginResp fromMap:dataDict type:ModelMapTypeAPI];
