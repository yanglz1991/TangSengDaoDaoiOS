...
// 群信息
@interface QCGroupModel : QCModel
...
@interface QCGroupMemberModel : QCModel
...
@property(nonatomic,assign) QCMemberRole role; // 成员角色  QCMemberRoleCommon,QCMemberRoleCreator,QCMemberRoleManager
...
-(QCChannelMember*) toChannelMember;
