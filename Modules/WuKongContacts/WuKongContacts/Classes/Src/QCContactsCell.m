...
#import <WuKongBase/QCOnlineBadgeView.h>
@implementation QCContactsCellModel


@end

@interface QCContactsCell()

@property(nonatomic,strong) QCUserAvatar *avatarImgView;
@property(nonatomic,strong) UILabel *nameLbl;
@property(nonatomic,strong) UILabel *subtitleLbl;
@property(nonatomic,strong) QCContactsCellModel *contactModel;

@property(nonatomic,strong) QCOnlineBadgeView *onlineBadgeView; // 在线状态view

@end
@implementation QCContactsCell
...
-(void) setupUI{
    ...
    _avatarImgView = [[QCUserAvatar alloc] initWithFrame:CGRectMake(0, 0, avatarWidth, avatarheight)];
    ...
    [_subtitleLbl setFont:[QCApp.shared.config appFontOfSize:12.0f]];
    [_subtitleLbl setTextColor:QCApp.shared.config.tipColor];
...
- (void)refresh:(id)cellModel {
    ...
    [self.avatarImgView.avatarImgView lim_setImageWithURL:[NSURL URLWithString:_contactModel.avatar] placeholderImage:[QCApp shared].config.defaultAvatar];
...
//        self.subtitleLbl.text = [QCOnlineStatusManager.shared onlineStatusDetailTip:self.contactModel.channelInfo];
