...
- (UIImageView *)bgImgView {
    if(!_bgImgView) {
        _bgImgView = [[UIImageView alloc] initWithImage:[[QCApp shared] loadImage:@"Background" moduleID:@"QCAuth"]];
...
- (UIImageView *)downArrowView {
    if(!_downArrowView) {
        ...
        [_downArrowView setImage:[[QCApp shared] loadImage:@"ArrowDown" moduleID:@"QCAuth"]];
    }
...
- (UIButton *)eyeBtn {
    if(!_eyeBtn) {
        ...
        [_eyeBtn setImage:[[QCApp shared] loadImage:@"BtnEyeOff" moduleID:@"QCAuth"] forState:UIControlStateNormal];
        [_eyeBtn setImage:[[QCApp shared] loadImage:@"BtnEyeOn" moduleID:@"QCAuth"] forState:UIControlStateSelected];
