...
@interface QCGroupBlacklistVC ()<QCGroupBlacklistVMDelegate>

@end

@implementation QCGroupBlacklistVC

- (instancetype)init
{
    self = [super init];
    if (self) {
        self.viewModel = [QCGroupBlacklistVM new];
...
#pragma mark - QCGroupBlacklistVMDelegate
